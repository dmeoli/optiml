...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.6]{img/lagrangian_dual_svc_loss_history}
	\caption{Lagrangian Dual SVC loss convergence}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.6]{img/lagrangian_dual_linear_svr_loss_history}
	\caption{Lagrangian Dual Linear SVC loss convergence}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.6]{img/lagrangian_dual_poly_svr_loss_history}
	\caption{Lagrangian Dual Polynomial SVC loss convergence}
	\label{fig:lagrangian_dual_poly_svr_loss_history}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.6]{img/lagrangian_dual_gaussian_svr_loss_history}
	\caption{Lagrangian Dual Gaussian SVC loss convergence}

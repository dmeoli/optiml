...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.55]{img/svc_hinge_loss_history}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.55]{img/lagrangian_dual_svc_loss_history}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.55]{img/svc_squared_hinge_loss_history}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.55]{img/lagrangian_dual_linear_svr_loss_history}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.55]{img/lagrangian_dual_poly_svr_loss_history}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.55]{img/lagrangian_dual_gaussian_svr_loss_history}

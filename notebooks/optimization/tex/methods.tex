...
\begin{definition}[Convexity] \label{def:convexity}
	...
	\begin{enumerate}[(i)]
		...
		$$
		\item We say that a twice differentiable function $f: \Re^m \rightarrow \Re$, i.e., $f \in C^2$, is convex iff: 
		$$ 
...
\begin{definition}[Strict Convexity] \label{def:strict_convexity}
	...
	\begin{enumerate}[(i)]
		...
		$$
		\item We say that a twice differentiable function $f: \Re^m \rightarrow \Re$, i.e., $f \in C^2$, is strictly convex iff: 
		$$ 
...
$$
and, if $f$ is a twice differentiable function, i.e., $f \in C^2$, then $f$ is $\mu$-strongly convex iff:
$$
...
Also, if $f$ is a twice differentiable function, i.e., $f \in C^2$, this is equivalent to:
$$
...
objective & 		& 		& 		\\
\midrule
$\mathcal{L}_1$-SVC~\eqref{eq:biased_primal_svc_hinge} & no & locally & convex \\
$\mathcal{L}_2$-SVC~\eqref{eq:biased_primal_svc_squared_hinge} & yes & globally & \vtop{\hbox{\strut 1-strongly}\hbox{\strut convex}} \\
\midrule
$\mathcal{L}_1$-SVR~\eqref{eq:biased_primal_svr_eps} & no & locally & convex \\
$\mathcal{L}_2$-SVR~\eqref{eq:biased_primal_svr_squared_eps} & yes & globally & \vtop{\hbox{\strut 1-strongly}\hbox{\strut convex}} \\
\bottomrule
\end{tabular}
\end{table}

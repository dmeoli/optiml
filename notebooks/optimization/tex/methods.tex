...
$\mathcal{L}_2$-SVM~(\ref{eq:l2_svc_lagrangian_dual},~\ref{eq:biased_wolfe_dual_svc_squared_hinge}) or~(\ref{eq:l2_svr_lagrangian_dual},~\ref{eq:biased_wolfe_dual_svr_squared_eps}) & $\displaystyle \mathcal{O}\Bigg(\frac{1}{t}\Bigg)$ \\
\bottomrule
\end{tabular}
\end{table}

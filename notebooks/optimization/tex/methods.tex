...
If $f$ is strongly convex, then the \emph{convergence rate} can be improved from $\displaystyle \mathcal{O}\Big(\frac{1}{\sqrt{t}}\Big)$ to $\displaystyle \mathcal{O}\Big(\frac{1}{t}\Big)$. Among algorithms that only use subgradient, these \emph{convergence rates} cannot be futher improved.

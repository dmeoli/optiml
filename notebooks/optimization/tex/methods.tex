...
$$
f(x) \leq f(y) + L_f \| x - y \| \ \forall \ x, y \in \Re^m
$$
$$
f(x) \geq f(y) - L_f \| x - y \| \ \forall \ x, y \in \Re^m
$$
...
\begin{theorem}[$L_f$-Lipschitz continuity for convex functions] \label{def:l_f_lipschitz_convex}
...
\begin{theorem}[$\mu$-strong convexity and L-Lipschitz continuity for convex functions]\label{def:strong_cvx_l_lipschitz_convex}

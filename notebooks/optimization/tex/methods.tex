...
$\mathcal{L}_2$-SVM~(\ref{eq:biased_primal_svc_squared_hinge},~\ref{eq:biased_primal_svr_squared_eps}) & $\displaystyle \mathcal{O}\Bigg(\exp\Bigg(-\frac{t}{\kappa}\Bigg)\Bigg)$ & $\displaystyle \mathcal{O}\Bigg(\exp\Bigg(-\frac{t}{\kappa}\Bigg)\Bigg)$ & $\displaystyle \mathcal{O}\Bigg(\exp\Bigg(-\frac{t}{\sqrt{\kappa}}\Bigg)\Bigg)$ \\
\bottomrule
\end{tabular}
\end{table}

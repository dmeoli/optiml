...
If $f$ is strongly convex, then the convergence guarantees can be improved from $\displaystyle \mathcal{O}\Big(\frac{1}{\sqrt{t}}\Big)$ to $\displaystyle \mathcal{O}\Big(\frac{1}{t}\Big)$.

...
\begin{titlepage}
	...
	\begin{minipage}{0.4\textwidth}
		\begin{center} \large
			\textbf{\theauthor}
			\href{mailto::d.meoli@studenti.unipi.it}{\texttt{d.meoli@studenti.unipi.it}}
		\end{center}
		\end{minipage}~
		\begin{minipage}{0.4\textwidth}
	\end{minipage}\\[2 cm]
...
\raggedleft{\itshape%
	...
	that makes my loss convex.\par\bigskip
}
\raggedleft{\textsc{Afterhours, me}\par}
\raggedright % restore the align

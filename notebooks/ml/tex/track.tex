...
\begin{itemize}
\item[\texttt{(A1.1.1)}] is a \emph{momentum descent} approach, an \emph{accelerated gradient} method for solving the SVC in its \emph{primal} formulation.
...
\begin{itemize}
\item[\texttt{(A1.2.1)}] is a \emph{momentum descent} approach, an \emph{accelerated gradient} method for solving the SVC in its \emph{primal} formulation.
\end{itemize}
...
\begin{itemize}
\item[\texttt{(A2.1.1)}] is a \emph{momentum descent} approach, an \emph{accelerated gradient} method for solving the SVR in its \emph{primal} formulation.
...
\begin{itemize}
\item[\texttt{(A2.2.1)}] is a \emph{momentum descent} approach, an \emph{accelerated gradient} method for solving the SVR in its \emph{primal} formulation.
\end{itemize}

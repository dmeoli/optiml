...
\begin{figure}[h!]
  \includegraphics[scale=0.5]{img/linear_dual_svr_hyperplane.png}
...
\begin{figure}[h!]
  \includegraphics[scale=0.5]{img/svr_eps_loss.png}
  \caption{SVR Epsilon-insensitive loss}
...
\begin{figure}[h!]
  \includegraphics[scale=0.5]{img/svr_squared_eps_loss.png}
  \caption{SVC Squared Epsilon-insensitive loss}

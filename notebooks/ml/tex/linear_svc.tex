...
\begin{figure}[h!]
	\centering
  	...
  	\caption{SVC Hinge loss with optimization steps}
...
It is a convex function and its gradient wrt $w$ is given by:
...
\begin{figure}[h!]
	\centering
  	...
  	\caption{SVC Squared Hinge loss with optimization steps}

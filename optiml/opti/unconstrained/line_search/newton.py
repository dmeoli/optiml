...
class Newton(LineSearchOptimizer):
    ...
    def __init__(self,
        ...
        :param delta:      (real scalar, optional, default value 1e-6): minimum positive value for the
                           eigenvalues of the modified Hessian used to compute the Newton direction.
        ...
        :param min_a:      (real scalar, optional, default value 1e-12): if the algorithm determines a step size

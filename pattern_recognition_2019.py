...
from ml.neural_network.activations import softmax, linear
...
if __name__ == '__main__':
    ...
    cnn.fit(X_train, y_train, loss=categorical_cross_entropy, optimizer=Adam, learning_rate=0.001,
            momentum_type='none', momentum=0.9, epochs=300, batch_size=64, max_f_eval=10000, verbose=True, plot=True)
